...
uses
  ...
  lynx_define_units, general_functions, lynx_population_dynamics, lynx_input_output_functions,
...
begin
  ...
  readmap_lynx(mapname_lynx, mapPops);

  SetLength(LynxMalesMap, Mapdimx + 1, Mapdimy + 1, 2);
  SetLength(LynxFemalesMap, Mapdimx + 1, Mapdimy + 1, 2);

  SetLength(LynxConnectionMap, Mapdimx + 1, Mapdimy + 1, 2);
